...
using UwpAppWithWindowsTemplateStudio.EventHandlers.Ink;
using UwpAppWithWindowsTemplateStudio.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace UwpAppWithWindowsTemplateStudio.Services.Ink
{
